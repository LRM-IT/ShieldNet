...
@Component({selector:'sn-public-brand',standalone:true,imports:[RouterLink,TranslatePipe],template:`<a routerLink="/" aria-label="GuildConsole"><span class="symbol"><i></i><i></i><i></i></span><span class="copy"><strong>GUILDCONSOLE</strong><small>{{'login.brand_subtitle'|snT:'SECURE CONTROL FABRIC'}}</small></span></a>`,styles:[`
