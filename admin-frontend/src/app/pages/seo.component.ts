...
<sn-shell title="SEO"><main class="page">
  <header><span>SUPERADMIN</span><h2>SEO и аналитика</h2><p>Метаданные главной страницы и подключение систем аналитики.</p></header>
  @if(settings();as s){
    <section class="card"><h3>SEO главной страницы</h3><div class="grid">
