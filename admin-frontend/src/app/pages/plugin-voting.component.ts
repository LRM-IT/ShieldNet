...
@Component({
 ...
 <main class="page">
  <header class="hero panel"><div><small>GUILDCONSOLE PLUGIN</small><h2>Multilingual Voting</h2>
  ...
  <section class="panel editor">
   ...
   <section class="result-settings">
    ...
    <div class="grid">
      <label>Theme<input [(ngModel)]="form.result_settings.theme" placeholder="Last War / EVEX / Cyber command"></label>
      <label>Visual prompt<input [(ngModel)]="form.result_settings.theme_prompt" placeholder="Dark military command center"></label>
      <label><input type="checkbox" [(ngModel)]="form.result_settings.publish_result_image"> Publish image after close</label>
      <label><input type="checkbox" [(ngModel)]="form.result_settings.highlight_winner"> Highlight winner</label>
    </div>
   </section>
   <div class="actions">
