...
@Component({
  ...
  styles:[`:host{display:block}.head{display:flex;align-items:end;justify-content:space-between;gap:1rem;padding:1rem 0 1.5rem}.head span{color:var(--accent);font-size:.66rem;font-weight:900;letter-spacing:.14em}.head h2{margin:.35rem 0}.head p{margin:0;color:var(--muted)}.head button,.actions a,.actions button{padding:.7rem 1rem;border:1px solid var(--line);border-radius:9px;background:var(--panel);color:var(--text);font-weight:800;cursor:pointer;text-decoration:none}.head button:disabled{opacity:.55;cursor:wait}.error{margin-bottom:1rem;padding:1rem;border:1px solid rgba(255,90,110,.3);border-radius:12px;color:#ff8d96;background:rgba(255,90,110,.06)}.grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:1rem}.card{padding:1.1rem;border:1px solid var(--line);border-radius:16px;background:var(--panel);min-width:0}.guild-head{display:grid;grid-template-columns:auto minmax(0,1fr) auto;align-items:center;gap:.75rem}.guild-head img,.avatar{width:44px;height:44px;border-radius:11px}.guild-head img{object-fit:cover}.avatar{display:grid;place-items:center;background:rgba(53,226,178,.12);color:var(--accent);font-weight:900}.guild-head>div:nth-child(2){display:grid;gap:.2rem;min-width:0}.guild-head strong,.guild-head small{overflow:hidden;text-overflow:ellipsis}.guild-head small{color:var(--muted)}.state{font-size:.65rem;text-transform:uppercase;color:#f0a94b;white-space:nowrap}.state i,.billing i{display:inline-block;width:7px;height:7px;border-radius:50%;margin-right:.4rem;background:currentColor}.state.online{color:var(--success)}.state.stale{color:#f0a94b}.stats{display:grid;grid-template-columns:repeat(3,1fr);gap:.5rem;margin:1rem 0}.stats div{padding:.7rem;border:1px solid var(--line);border-radius:10px;display:grid;gap:.3rem;min-width:0}.stats span{color:var(--muted);font-size:.66rem;text-transform:uppercase}.stats strong{overflow:hidden;text-overflow:ellipsis;font-size:.88rem}.billing{display:block;color:var(--muted);font-size:.72rem;margin-bottom:1rem}.billing.active{color:var(--success)}.billing.expired{color:#ff8d96}.actions{display:flex;gap:.5rem;flex-wrap:wrap}.actions a,.actions button{font-size:.78rem;padding:.55rem .7rem}.actions .primary{background:var(--accent);border-color:var(--accent);color:#04130f}.actions .danger{color:#ff8d96;border-color:rgba(255,90,110,.35)}.empty{grid-column:1/-1;padding:2rem;border:1px solid var(--line);border-radius:14px;color:var(--muted)}@media(max-width:1100px){.grid{grid-template-columns:repeat(2,1fr)}}@media(max-width:720px){.grid{grid-template-columns:1fr}.head{align-items:flex-start;flex-direction:column}.guild-head{grid-template-columns:auto minmax(0,1fr)}.state{grid-column:1/-1}.stats{grid-template-columns:1fr 1fr 1fr}}@media(max-width:430px){.stats{grid-template-columns:1fr}.actions>*{width:100%;text-align:center}}`]
})
