...
export class ServerSelectorComponent implements OnInit,OnDestroy {
  ...
  async ngOnInit(){this.guilds.set(await this.service.list());this.timer=setInterval(()=>this.now.set(Date.now()),1000)}
